            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <?php echo (form_error('o_days') != "") ? 'is-invalid' : '';?>" data-placeholder="Choose a Category"
                        ...
                        <option value="Senin - Jumat" <?php echo $store['o_days'] == "sen-jum" ? "selected" : "";?>">Senin - Jumat</option>
                        <option value="Senin - Sabtu" <?php echo $store['o_days'] == "sen-sab" ? "selected" : "";?>>Senin - Sabtu</option>
                        <option value="Setiap Hari" <?php echo $store['o_days'] == "setiaphr" ? "selected" : "";?>>Setiap Hari</option>
                    </select>
