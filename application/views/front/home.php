...
<div class="container-fluid padding">
    <div class="row text-center welcome">
        <div class="col-12">
            <h1 class="display-4">Pesan Makanan Dengan 3 Cara Mudah</h1>
        </div>
        <hr>
        <div class="col-12">
            <p class="lead">Cara termudah untuk memesan makanan Anda. YoFood menyediakan pengiriman
                cepat dalam waktu 30 menit dan menyediakan makanan gratis jika pesanan tidak tepat waktu. Jadi tunggu apalagi, pesan sekarang juga!</p>
        </div>
    </div>
</div>
<div class="container-fluid padding">
    <div class="row text-center padding">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4">
            ...
            <h3>Pilih Makanan Favorit Kamu</h3>
            <p>Kami menyediakan Anda dengan menu dari berbagai restoran pengiriman online!</p>
        </div>
        <div class="col-sm-12 col-md-4">
        <i class="fas fa-clipboard-check"></i>
            <h3>Kirim atau Ambil ditempat</h3>
            <p>Pesanan akan dikirim atau Anda dapat mengambilnya sesuai pilihan Anda!</p>
        </div>
    </div>
    <hr class="my-4">
</div>
<div class="container-fluid padding">
    <div class="row welcome text-center welcome">
        <div class="col-12">
            <h1 class="display-4">Hot Menu</h1>
        </div>
        <hr>
    </div>
</div>
