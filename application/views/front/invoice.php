    ...
    <div class="container my-3" style="border: 2px outset green;">
        ...
        <div class="invoice mb-3">
            <div class="row mb-3 p-3">
                <div class="col-6">
                    <h3 style="color:black"><b>Yo<span style="color: #51b400">Food.</span></b></h3>
                </div>
                <div class="col-6">
        ...
        <footer class="text-center">
            <p class="mb-0">Terimakasih atas pesanannya.</p>
            <p>Jangan lupa untuk order lagi ya!</p>
            <p>Syarat dan ketentuan silahkan kunjungi www.website.com</p>
        </footer>
    </div>
