            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody id="myTable">
                    ...
                    <tr>
                        ...
                        <td> <button type="button" class="btn btn-secondary" style="font-weight:bold;"><i class="fas fa-bars"></i> Menunggu Konfirmasi</button></td>
                        <?php } if($status=="in process") { ?>
                        <td> <button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin" aria-hidden="true"></span> Sedang Diproses</button></td>
                        <?php }?>
...
<script>
    function deleteOrder(id) {
        if (confirm("Kamu ingin membatalkan pesanan ini?")) {
